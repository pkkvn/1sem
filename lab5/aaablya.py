...
def rand_coordx():
    return (randint(25, LENGTH - 25))

def rand_coordy():
    return (randint(25, HEIGHT - 25))
...
class Shell:
    ...
    def detect_collision(self, other):
        len = (self.coord[0] - other.coord[0])**0.5 + (self.coord[1] - other.coord[1])**0.5
        return len <= self.rad + other.rad
...
class Target:
    ...
    def __init__(self, coord=None, color=None, rad=30):
        ...
        '''
        if coord == None:
            coord = [randint(50, SCREEN_SIZE[0] - 50), randint(50, SCREEN_SIZE[1] - 50)]
        self.coord = coord
        self.rad = rad
        if color == None:
            color = rand_color()
    ...
    def check_collision(self, ball):
        ...
        '''
        dist = ((self.coord[0] - ball.coord[0])**2 + (self.coord[1] - ball.coord[1])**2)**0.5
        min_dist = self.rad + ball.rad
        return dist <= min_dist

    def draw(self, screen, rad = 15):
        '''
        Draws the target on the screen
        '''
        pg.draw.circle(screen, self.color, self.coord, rad)
